# Catppuccin Mocha with Jetbrains Mono Nerd Font for Discord
> [!NOTE]  
> This is a fork of the [original Catppuccin Mocha theme for Discord](https://github.com/catppuccin/discord), slightly modified to use the [Jetbrains Mono Nerd Font](https://www.jetbrains.com/lp/mono/) instead of the default font.

The font is forced to every text element in Discord, including the chat input box, messages, and even bypasses the custom username fonts feature. This ensures a consistent look and feel throughout the application.
